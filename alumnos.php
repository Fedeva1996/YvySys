    ...
    <div class="container">
        ...
        <div class="mb-3" data-bs-theme="dark">
            <form id="formBuscarAlumno">
                ...
                <button class="btn btn-dark" type="reset" onclick="loadAlumnos()"><i class="bi bi-eraser"></i> Limpiar</button>
            </form>
        </div>
        <!-- Tabla -->
                    ...
                    <form id="formAgregarAlumno">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    <input class="input-group-text w-100" type="date" name="fecha_nac" placeholder="Fecha nacimiento" required>
                                </div>
                                <div class="mb-3">
