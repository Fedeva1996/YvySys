...
$pdf->Cell(100, 6, 'LISTA DE PROCESOS DE CLASE', 0, 0, 'C');
...
$pdf->Cell(20, 6, 'Puntaje', 1, 0, 'C', 1);
$pdf->Cell(30, 6, 'Alumno', 1, 0, 'C', 1);
$pdf->Cell(30, 6, 'Puntaje hecho', 1, 0, 'C', 1);
$pdf->Cell(17, 6, 'Estado', 1, 1, 'C', 1);
...
while ($fila = pg_fetch_assoc($resultado)) {
    ...
    $pdf->Cell(20, 6, ($fila['puntaje']), 1, 0, 'C');
    $pdf->Cell(30, 6, ($fila['nombre'] ." ". $fila['apellido']), 1, 0, 'C');
    $pdf->Cell(30, 6, $fila['estado'], 1, 0, 'C');
    $pdf->Cell(17, 6, $fila['puntaje_hecho'], 1, 1, 'C');
}


//$pdf->AddPage(); //Agregar nueva Pagina

$pdf->Output('Informe procesos de clase' . date('d_m_y') . '.pdf', 'I'); 
